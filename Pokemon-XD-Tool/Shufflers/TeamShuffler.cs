...
namespace Randomizer.Shufflers
{
    ...
    {
        public static void ShuffleTeams(IRandom random, TeamShufflerSettings settings, ExtractedGame extractedGame)
        {
        ...
        public static void RandomizePokemon(IRandom random, TeamShufflerSettings settings, ITrainerPokemon pokemon, Pokemon[] pokemonList)
        {
        ...
        public static void RandomizeMoveSet(IRandom random, TeamShufflerSettings settings, ITrainerPokemon pokemon, ExtractedGame extractedGame)
        {
            ushort[] moveSet = null;
